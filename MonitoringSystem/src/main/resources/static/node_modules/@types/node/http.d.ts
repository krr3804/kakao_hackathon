...
declare module 'http' {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * a subclass of `stream.Duplex`, unless the member specified a socket
         ...
         * `max-forwards`, `proxy-authorization`, `referer`,`retry-after`, `server`, or `member-agent` are discarded.
