...
declare module 'crypto' {
    ...
    class ECDH {
         ...
         * usually supplied from a remote member over an insecure network,
    ...
    namespace webcrypto {
        ...
        interface CryptoKeyConstructor {
            /** Illegal constructor */
            (_: { readonly _: unique symbol }): never; // Allows instanceof to work but not be callable by the member.
            readonly length: 0;
