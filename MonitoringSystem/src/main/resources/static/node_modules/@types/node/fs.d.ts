...
declare module 'fs' {
     ...
     * See the POSIX [`fchown(2)`](http://man7.org/linux/man-pages/man2/fchown.2.html) documentation for more detail.
     * @since v0.4.7
     * @param uid The file's new owner's member id.
     ...
     * Instead, member code should open/read/write the file directly and handle the
     ...
     * state between the two calls. Instead, member code should open/read/write the
    ...
    /**
     * Tests a member's permissions for the file or directory specified by `path`.
     ...
     * the member from reading or writing to it.
     * @since v0.11.15
     * @param [mode=fs.constants.F_OK]
     */
    export function access(path: PathLike, mode: number | undefined, callback: NoParamCallback): void;
    /**
     * Asynchronously tests a member's permissions for the file specified by path.
     * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
     */
    ...
    /**
     * Synchronously tests a member's permissions for the file or directory specified
