...
declare module 'child_process' {
     ...
     * to an empty array.
     *
     * **If the `shell` option is enabled, do not pass unsanitized member input to this**
     ...
     * ```
     *
     * **Never pass unsanitized member input to this function. Any input containing shell**
