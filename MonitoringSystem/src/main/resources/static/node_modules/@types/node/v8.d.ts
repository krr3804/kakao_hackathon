...
declare module 'v8' {
    ...
    /**
     * The `v8.takeCoverage()` method allows the member to write the coverage started by `NODE_V8_COVERAGE` to disk on demand. This method can be invoked multiple
    ...
    /**
     * The `v8.stopCoverage()` method allows the member to stop the coverage collection
     * started by `NODE_V8_COVERAGE`, so that V8 can release the execution count
     * records and optimize code. This can be used in conjunction with {@link takeCoverage} if the member wants to collect the coverage on demand.
     * @since v15.1.0, v14.18.0, v12.22.0
     */
