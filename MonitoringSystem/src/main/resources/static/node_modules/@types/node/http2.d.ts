...
declare module 'http2' {
    ...
    export interface ServerHttp2Stream extends Http2Stream {
         ...
         * ```
         *
         * The optional `options.statCheck` function may be specified to give member code
    ...
    /**
     * This object is created internally by an HTTP server, not by the member. It is
    ...
    export class Http2ServerResponse extends stream.Writable {
         ...
         * buffer. Returns `false` if all or part of the data was queued in member memory.`'drain'` will be emitted when the buffer is free again.
         * @since v8.4.0
         */
     ...
     * is used). Userinfo (member ID and password), path, querystring, and fragment details in the URL will be ignored.
